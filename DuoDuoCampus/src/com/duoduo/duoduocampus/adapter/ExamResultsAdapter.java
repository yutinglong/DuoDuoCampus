...
public class ExamResultsAdapter extends BaseAdapter {
	...
	private List<ExamResult> data = new ArrayList<ExamResult>();

	public ExamResultsAdapter(Context context, List<ExamResult> dataList) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		holder.title.setText((String) data.get(position).result);
		holder.datatime.setText((String) data.get(position).rank);
